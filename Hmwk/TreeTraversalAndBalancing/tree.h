    ...
    if (root != NULL) {
        ...
        if (nodeWithEntry != NULL) {
            ...
            if (nodeWithEntry->left != NULL && nodeWithEntry->right != NULL) {
                ...
                std::cout << "Swapping " << nodeWithEntry->data << " at address " << nodeWithEntry
                        << "with " << nodeToRemove->data << " at address " << nodeToRemove << "\n";

                nodeWithEntry->data = nodeToRemove->data;
                nodeWithEntry = nodeToRemove;
                std::cout << "Verifying delete of " << nodeWithEntry->data << " at address " << nodeWithEntry << "\n";
            }
...
void Tree<T>::removeNode(Node *nodeToRemove, Node *parentNode) {
    ...
    std::cout << "Deleting " << nodeToRemove->data << " at address: " << nodeToRemove << "\n";
